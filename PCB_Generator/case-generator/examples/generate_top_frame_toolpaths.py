"""
Example script to generate CNC toolpaths for top frame component.

This script demonstrates the complete toolpath generation workflow
for the top frame, including all operations from surfacing to profile cutting.
"""
...
def main():
    """Generate and display top frame toolpaths."""
    
    print("=" * 80)
    print("TOP FRAME CNC TOOLPATH GENERATION")
    print("=" * 80)
    print()
    ...
    print()
    print("=" * 80)
    print("TOOLPATH GENERATION COMPLETE")
    print("=" * 80)
    ...
    output_file = os.path.join(output_dir, 'top_frame_toolpaths.json')
    ...
    print(f"\nToolpaths saved to: {output_file}")
    print()
