...
from src.geometry.profiles_lp import generate_bottom_tray_profile
...
def main():
    ...
    print("=" * 80)
    print("60% Keyboard Case - LOW-PROFILE Bottom Tray CNC Toolpath Generation")
    print("=" * 80)
    print(f"Height: {BOTTOM_TRAY_HEIGHT}mm (LOW-PROFILE: reduced from 15mm standard)")
    print(f"Cavity Depth: {CAVITY_DEPTH}mm (LOW-PROFILE: reduced from 10mm standard)")
    print()
    ...
    output_file = os.path.join(output_dir, 'bottom_tray_toolpaths_lp.json')
