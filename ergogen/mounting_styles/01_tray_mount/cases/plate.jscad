function switch_plate_extrude_1_6_outline_fn(){
    return new CSG.Path2D([[-10,28.05],[-10,-9]]).appendArc([-9,-10],{"radius":1,"clockwise":false,"large":false}).appendPoint([28.05,-10]).appendArc([29.05,-9],{"radius":1,"clockwise":false,"large":false}).appendPoint([29.05,28.05]).appendArc([28.05,29.05],{"radius":1,"clockwise":false,"large":false}).appendPoint([-9,29.05]).appendArc([-10,28.05],{"radius":1,"clockwise":false,"large":false}).close().innerToCAG()
.subtract(
