// Generated from KLE by kle-to-ergogen-via-scad converter
// Keys: 40
...
base_switch_layout = [
  ...
  [[[11,0],1.5,[0,0,0]],[1,1,1+0.25*unit*mm,1+0.25*unit*mm],false],
  ...
  [[[1.25,3],1.25,[0,0,0]],[1,1,1+0.125*unit*mm,1+0.125*unit*mm],false],
  [[[2.5,3],1.25,[0,0,0]],[1,1,1+0.125*unit*mm,1+0.125*unit*mm],false],
  [[[3.75,3],6.25,[0,0,0]],[1,1,1+2.625*unit*mm,1+2.625*unit*mm],false],
  [[[10,3],1.25,[0,0,0]],[1,1,1+0.125*unit*mm,1+0.125*unit*mm],false],
  [[[11.25,3],1.25,[0,0,0]],[1,1,1+0.125*unit*mm,1+0.125*unit*mm],false],
];
...
base_stab_layout = [
  [[[3.75,3],6.25,[0,0,0]],[1,1,1+2.625*unit*mm,1+2.625*unit*mm],stab_6_25u],
];
